...
class LoraLinear(lora.LoRALayer, nn.Module):
    ...
    来源：https://github.com/sunzeyeah/RLHF/blob/master/src/models/lora.py
    """
    def __init__(
        self,
        weight: nn.Parameter,
        ...
        lora.LoRALayer.__init__(self, r=r, lora_alpha=lora_alpha, lora_dropout=lora_dropout, merge_weights=merge_weights)
        self.weight = weight
        self.bias = bias
