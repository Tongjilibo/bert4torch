...
VIDEO_PROCESSOR_MAPPING: Dict[str, Type[BaseVideoProcessor]] = {"BaseVideoProcessor": BaseVideoProcessor}
register_video_processor = create_registrar(VIDEO_PROCESSOR_MAPPING)