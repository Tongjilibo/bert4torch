...
from .image_processing_base import BatchFeature, register_image_processor
...
from ..snippets.import_utils import is_rocm_platform, is_torchdynamo_compiling, requires
...
@register_image_processor(name="BaseImageProcessorFast")
