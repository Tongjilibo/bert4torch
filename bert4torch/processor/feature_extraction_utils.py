...
FEATURE_EXTRACTOR_MAPPING: Dict[str, Type[FeatureExtractionMixin]] = {"FeatureExtractionMixin": FeatureExtractionMixin}
register_feature_extractor = create_registrar(FEATURE_EXTRACTOR_MAPPING)