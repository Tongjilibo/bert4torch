...
from typing import Any, Optional, TypeVar, Union, Dict, Type
import numpy as np
import requests
...
IMAGE_PROCESSOR_MAPPING: Dict[str, Type[ImageProcessingMixin]] = {"ImageProcessingMixin": ImageProcessingMixin}
register_image_processor = create_registrar(IMAGE_PROCESSOR_MAPPING)