...
class Qwen2Decoder2Encoder(Qwen2):
    """
    ...
    def forward(self, x: torch.Tensor) -> torch.Tensor:
        ...
        y = self.forward_qwen(x_combined, token_type_ids=token_type_ids)
    ...
    def forward_qwen(
        ...
        causal_mask = self._update_causal_mask(attention_mask, input_ids)
