    ...
    def from_pretrained(cls, pretrained_model_name_or_path, *inputs, **kwargs):
        ...
        if video_processor_class is None and video_processor_auto_map is None:
            ...
            if image_processor_class is not None:
                ...
                if video_processor_class_inferred in VIDEO_PROCESSOR_MAPPING:
        ...
        if video_processor_class is not None:
            video_processor_class = VIDEO_PROCESSOR_MAPPING[video_processor_class]

        has_remote_code = video_processor_auto_map is not None
        has_local_code = video_processor_class is not None or type(config).__name__ in VIDEO_PROCESSOR_MAPPING
        ...
        elif type(config).__name__ in VIDEO_PROCESSOR_MAPPING:
            video_processor_class = VIDEO_PROCESSOR_MAPPING[type(config).__name__]
        ...
        raise ValueError(
            ...
            f"`model_type` keys in its {CONFIG_NAME}: {', '.join(c for c in VIDEO_PROCESSOR_MAPPING)}"
        )
