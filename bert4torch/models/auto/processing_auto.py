...
from ...processor.feature_extraction_utils import FeatureExtractionMixin
...
class AutoProcessor:
    ...
    def from_pretrained(cls, pretrained_model_name_or_path, **kwargs):
        ...
        ```python
        >>> from bert4torch import AutoProcessor
        ...
        elif type(config).__name__ in PROCESSOR_MAPPING:
            return PROCESSOR_MAPPING[type(config).__name__].from_pretrained(pretrained_model_name_or_path, **kwargs)
