...
import numpy as np
from ...processor.image_processing_base import register_image_processor
from ...processor.image_processing_utils import BaseImageProcessor, BatchFeature
from ...processor.image_transforms import (
    PaddingMode,
    get_image_size,
    pad,
    resize,
