...
from ...processor.image_utils import ImageInput, make_nested_list_of_images
from ...processor.processing_utils import ImagesKwargs, ProcessingKwargs, ProcessorMixin, Unpack, register_processor
...
class MllamaProcessor(ProcessorMixin):
    ...
    The preferred way of passing kwargs is as a dictionary per modality, see usage example below.
        ```python
        from bert4torch import MllamaProcessor
