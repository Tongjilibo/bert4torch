...
from ...tokenizers.tokenization_utils_tokenizers import register_tokenizer
from ...tokenizers.tokenization_python import PythonBackend
from ...tokenizers.tokenization_utils_base import EncodedInput, BatchEncoding
from ...snippets import logging, PaddingStrategy
...
@register_tokenizer
class ChatGLM3Tokenizer(PythonBackend):
    ...
    def build_chat_input(self, query, history=None, role="user"):
        ...
        return self._encode_plus([input_ids], return_tensors="pt", is_split_into_words=True)
