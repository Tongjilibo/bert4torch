...
from ...snippets import TensorType, add_start_docstrings, is_torchvision_available
from ...processor.video_processing_utils import BASE_VIDEO_PROCESSOR_DOCSTRING, BaseVideoProcessor
