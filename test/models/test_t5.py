...
@pytest.mark.parametrize("model_dir", ['E:/data/pretrain_ckpt/ClueAI/ChatYuan-large-v1/'])
...
@pytest.mark.parametrize("model_dir", ['E:/data/pretrain_ckpt/ClueAI/PromptCLUE-base-v1-5/'])
@torch.inference_mode()
...
@pytest.mark.parametrize("model_dir", ['E:/data/pretrain_ckpt/Tongjilibo/chinese_t5_pegasus_small/',
                                       'E:/data/pretrain_ckpt/Tongjilibo/chinese_t5_pegasus_base/'])
@torch.inference_mode()
...
@pytest.mark.parametrize("model_dir", ['E:/data/pretrain_ckpt/uer/t5-small-chinese-cluecorpussmall/',
                                       'E:/data/pretrain_ckpt/uer/t5-base-chinese-cluecorpussmall/'])
@torch.inference_mode()
...
if __name__=='__main__':
    test_chatyuan('E:/data/pretrain_ckpt/ClueAI/ChatYuan-large-v1/')
    test_PromptCLUE('E:/data/pretrain_ckpt/ClueAI/PromptCLUE-base-v1-5/')
    test_t5_pegasus('E:/data/pretrain_ckpt/Tongjilibo/chinese_t5_pegasus_small/')
    test_t5_ner('E:/data/pretrain_ckpt/uer/t5-base-chinese-cluecorpussmall/')