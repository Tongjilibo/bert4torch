...
@pytest.mark.parametrize("model_dir", ["/data/pretrain_ckpt/bert/google@bert-base-chinese",
                                       "/data/pretrain_ckpt/bert/bert-base-multilingual-cased",
                                       "/data/pretrain_ckpt/bert/hfl@macbert-base",
                                       "/data/pretrain_ckpt/bert/hfl@chinese-bert-wwm-ext"])
...
if __name__=='__main__':
    test_bert("/data/pretrain_ckpt/bert/hfl@chinese-bert-wwm-ext")