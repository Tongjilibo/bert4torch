...
@pytest.mark.parametrize("model_dir", ["/data/pretrain_ckpt/transformer_xl/huggingface@transfo-xl-wt103",
                                       "/data/pretrain_ckpt/xlnet/hfl@chinese-xlnet-base"])
...
if __name__=='__main__':
    test_xlnet("/data/pretrain_ckpt/transformer_xl/huggingface@transfo-xl-wt103")