...
@pytest.mark.parametrize("model_dir", ["/data/pretrain_ckpt/gpt/cpm@cpm_lm_2.6b/",
                                       '/data/pretrain_ckpt/gpt/uer@gpt2-chinese-cluecorpussmall/'])
...
@pytest.mark.parametrize("model_dir", ['/data/pretrain_ckpt/gpt/imcaspar@gpt2-ml_15g_corpus_torch'])
@torch.inference_mode()
...
if __name__=='__main__':
    test_gpt2_ml('/data/pretrain_ckpt/gpt/imcaspar@gpt2-ml_15g_corpus_torch')