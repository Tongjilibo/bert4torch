...
train_dataloader = DataLoader(MyDataset([
    'G:/data/corpus/sentence_classification/sentiment/sentiment.train.data',
    'G:/data/corpus/sentence_classification/sentiment/sentiment.valid.data',
    'G:/data/corpus/sentence_classification/sentiment/sentiment.test.data']), 
