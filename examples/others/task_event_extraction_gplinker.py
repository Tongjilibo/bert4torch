...
train_path = '/data/corpus/event_extraction/duee/duee_train.json'
valid_path = '/data/corpus/event_extraction/duee/duee_dev.json'
test_path = '/data/corpus/event_extraction/duee/duee_test2.json'
schema_path = '/data/corpus/event_extraction/duee/duee_event_schema.json'
