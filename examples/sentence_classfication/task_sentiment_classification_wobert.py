...
maxlen = 256
batch_size = 16
config_path = '/data/pretrain_ckpt/junnyu/wobert_chinese_plus_base/bert4torch_config.json'
checkpoint_path = '/data/pretrain_ckpt/junnyu/wobert_chinese_plus_base/pytorch_model.bin'
dict_path = '/data/pretrain_ckpt/junnyu/wobert_chinese_plus_base/vocab.txt'
...
# 建立分词器
tokenizer = BertTokenizer(dict_path, do_lower_case=True, pre_tokenize=lambda s: jieba.cut(s, HMM=False))
