...
maxlen = 256
batch_size = 16
config_path = '/Users/lb/Documents/pretrain_ckpt/wobert/[huggingface_torch_base]--wobert_chinese_base/config.json'
checkpoint_path = '/Users/lb/Documents/pretrain_ckpt/wobert/[huggingface_torch_base]--wobert_chinese_base/pytorch_model.bin'
dict_path = '/Users/lb/Documents/pretrain_ckpt/wobert/[huggingface_torch_base]--wobert_chinese_base/vocab.txt'
...
# 加载数据集
train_dataloader = DataLoader(MyDataset(['/Users/lb/Documents/data/sentence_classification/sentiment/sentiment.train.data']), batch_size=batch_size, shuffle=True, collate_fn=collate_fn) 
valid_dataloader = DataLoader(MyDataset(['/Users/lb/Documents/data/sentence_classification/sentiment/sentiment.valid.data']), batch_size=batch_size, collate_fn=collate_fn) 
test_dataloader = DataLoader(MyDataset(['/Users/lb/Documents/data/sentence_classification/sentiment/sentiment.test.data']),  batch_size=batch_size, collate_fn=collate_fn) 
