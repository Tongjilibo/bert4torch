...
maxlen = 256
batch_size = 16
config_path = '/data/pretrain_ckpt/deberta/IDEA-CCNL@Erlangshen-DeBERTa-v2-97M-Chinese/config.json'
checkpoint_path = '/data/pretrain_ckpt/deberta/IDEA-CCNL@Erlangshen-DeBERTa-v2-97M-Chinese/pytorch_model.bin'
dict_path = '/data/pretrain_ckpt/deberta/IDEA-CCNL@Erlangshen-DeBERTa-v2-97M-Chinese/vocab.txt'
...
# 加载数据集
train_dataloader = DataLoader(MyDataset(['/data/corpus/sentence_classification/sentiment/sentiment.train.data']), batch_size=batch_size, shuffle=False, collate_fn=collate_fn) 
