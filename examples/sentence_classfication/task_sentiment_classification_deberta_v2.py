...
maxlen = 256
batch_size = 16
config_path = 'E:/pretrain_ckpt/deberta/[IDEA-CCNL-torch]--Erlangshen-DeBERTa-v2-97M-Chinese/config.json'
checkpoint_path = 'E:/pretrain_ckpt/deberta/[IDEA-CCNL-torch]--Erlangshen-DeBERTa-v2-97M-Chinese/bert4torch_pytorch_model.bin'
dict_path = 'E:/pretrain_ckpt/deberta/[IDEA-CCNL-torch]--Erlangshen-DeBERTa-v2-97M-Chinese/vocab.txt'
...
# 加载数据集
train_dataloader = DataLoader(MyDataset(['E:/data/corpus/sentence_classification/sentiment/sentiment.train.data']), batch_size=batch_size, shuffle=False, collate_fn=collate_fn) 
