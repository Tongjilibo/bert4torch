...
maxlen = 256
batch_size = 16
config_path = 'E:/pretrain_ckpt/deberta/IDEA-CCNL@Erlangshen-DeBERTa-v2-97M-Chinese/config.json'
checkpoint_path = 'E:/pretrain_ckpt/deberta/IDEA-CCNL@Erlangshen-DeBERTa-v2-97M-Chinese/pytorch_model.bin'
dict_path = 'E:/pretrain_ckpt/deberta/IDEA-CCNL@Erlangshen-DeBERTa-v2-97M-Chinese/vocab.txt'
