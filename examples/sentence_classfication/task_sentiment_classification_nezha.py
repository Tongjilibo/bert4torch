...
maxlen = 256
batch_size = 16
config_path = '/data/pretrain_ckpt/sijunhe/nezha-cn-base/bert4torch_config.json'
checkpoint_path = '/data/pretrain_ckpt/sijunhe/nezha-cn-base/pytorch_model.bin'
dict_path = '/data/pretrain_ckpt/sijunhe/nezha-cn-base/vocab.txt'
