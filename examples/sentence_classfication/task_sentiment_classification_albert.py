...
maxlen = 256
batch_size = 16
config_path = '/data/pretrain_ckpt/albert/brightmart@albert_small_zh/bert4torch_config.json'
checkpoint_path = '/data/pretrain_ckpt/albert/brightmart@albert_small_zh/pytorch_model.bin'
dict_path = '/data/pretrain_ckpt/albert/brightmart@albert_small_zh/vocab.txt'
