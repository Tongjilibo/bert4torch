...
maxlen = 256
batch_size = 16
config_path = '/data/pretrain_ckpt/hfl/chinese-electra-base-discriminator/bert4torch_config.json'
checkpoint_path = '/data/pretrain_ckpt/hfl/chinese-electra-base-discriminator/pytorch_model.bin'
dict_path = '/data/pretrain_ckpt/hfl/chinese-electra-base-discriminator/vocab.txt'
