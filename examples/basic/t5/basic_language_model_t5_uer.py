...
config_path = 'E:/pretrain_ckpt/t5/uer@t5-small-chinese-cluecorpussmall/bert4torch_config.json'
...
# config_path = 'E:/pretrain_ckpt/t5/uer@t5-base-chinese-cluecorpussmall/bert4torch_config.json'
