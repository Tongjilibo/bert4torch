...
if choice == 'roformer':
    args_model_path = "G:/pretrain_ckpt/roformer/[sushen_torch_base]--roformer_v1_base/"
    args_model = 'roformer'
else:
    args_model_path = "G:/pretrain_ckpt/roformer/[sushen_torch_base]--roformer_v2_char_base/"
