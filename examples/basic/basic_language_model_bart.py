...
# 选择v1还是v2
# ckpt_dir = "F:/Projects/pretrain_ckpt/bart/[FudanNLP_torch_base]/"  # v1.0
ckpt_dir = "F:/Projects/pretrain_ckpt/bart/[FudanNLP_torch_base_v2.0]/"  # v2.0
...
autotitle = AutoTitle(start_id=102, end_id=tokenizer._token_end_id, maxlen=maxlen, device=device)
for text in texts:
