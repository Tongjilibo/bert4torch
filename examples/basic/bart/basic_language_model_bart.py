...
# 选择v1还是v2
# ckpt_dir = "E:/data/pretrain_ckpt/bart/fnlp@bart-base-chinese/"  # v1.0
ckpt_dir = "E:/data/pretrain_ckpt/bart/fnlp@bart-base-chinese-v2.0/"  # v2.0
...
class AutoTitle(AutoRegressiveDecoder):
    ...
    def generate(self, text, top_k=4):
...
for text in texts:
    print(text, ' -> ', autotitle.generate(text, top_k=top_k))
...
results = autotitle.generate(texts, top_k=top_k)
