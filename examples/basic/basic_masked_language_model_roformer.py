...
if choice == 'roformer':
    args_model_path = "F:/Projects/pretrain_ckpt/roformer/roformer_v1_base/"
    args_model = 'roformer'
else:
    args_model_path = "F:/Projects/pretrain_ckpt/roformer/roformer_v2_char_base/"
...
model = build_transformer_model(config_path, checkpoint_path, model=args_model, with_mlm=True)  # 建立模型，加载权重
