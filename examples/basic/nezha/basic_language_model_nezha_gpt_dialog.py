...
# nezha配置
config_path = 'E:/data/pretrain_ckpt/Tongjilibo/nezha_gpt_dialog/bert4torch_config.json'
checkpoint_path = 'E:/data/pretrain_ckpt/Tongjilibo/nezha_gpt_dialog/pytorch_model.bin'
dict_path = 'E:/data/pretrain_ckpt/Tongjilibo/nezha_gpt_dialog/vocab.txt'
