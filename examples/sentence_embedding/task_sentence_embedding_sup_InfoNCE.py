...
train_data = get_data(f'/data/corpus/sentence_embedding/{task_name}/{task_name}.train.data')
...
# 加载数据集
valid_dataloader = DataLoader(MyDataset(f'/data/corpus/sentence_embedding/{task_name}/{task_name}.valid.data'), batch_size=batch_size, collate_fn=collate_fn_eval)
test_dataloader = DataLoader(MyDataset(f'/data/corpus/sentence_embedding/{task_name}/{task_name}.test.data'), batch_size=batch_size, collate_fn=collate_fn_eval)
