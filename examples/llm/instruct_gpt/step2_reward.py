...
def collate_fn(batch):
    ...
    # padding在左侧
    input_ids_chosen = torch.tensor(sequence_padding(input_ids_chosen, value=pad_token_id, padding_side='left'), dtype=torch.long, device=args.device)
    input_ids_rejected = torch.tensor(sequence_padding(input_ids_rejected, value=pad_token_id, padding_side='left'), dtype=torch.long, device=args.device)
