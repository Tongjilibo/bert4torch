...
| THUCNews       | 文本分类、文本生成 | [源文件](http://thuctc.thunlp.org/#%E4%B8%AD%E6%96%87%E6%96%87%E6%9C%AC%E5%88%86%E7%B1%BB%E6%95%B0%E6%8D%AE%E9%9B%86THUCNews), [转换后文件](https://huggingface.co/datasets/Tongjilibo/THUCNews) |
...
## 指令微调
- [Belle-0.5M-cn](https://huggingface.co/datasets/BelleGroup/train_0.5M_CN): 包含约50万条由BELLE项目生成的中文指令数据
- [Belle-1M-cn](https://huggingface.co/datasets/BelleGroup/train_1M_CN): 包含约100万条由BELLE项目生成的中文指令数据
...
- [fnlp/moss-002-sft-data](https://huggingface.co/datasets/fnlp/moss-002-sft-data)
