...
import torch
state_dict = torch.load('G:/pretrain_ckpt/roberta/[guwen_hf_torch_base]--ethanyt-guwenbert-base/pytorch_model.bin')
...
torch.save(state_dict_new, 'G:/pretrain_ckpt/roberta/[guwen_hf_torch_base]--ethanyt-guwenbert-base/bert4torch_pytorch_model.bin')