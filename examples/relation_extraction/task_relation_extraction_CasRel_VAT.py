...
maxlen = 256
batch_size = 8
config_path = '/data/pretrain_ckpt/hfl/chinese-bert-wwm-ext/bert4torch_config.json'
checkpoint_path = '/data/pretrain_ckpt/hfl/chinese-bert-wwm-ext/pytorch_model.bin'
dict_path = '/data/pretrain_ckpt/hfl/chinese-bert-wwm-ext/vocab.txt'
