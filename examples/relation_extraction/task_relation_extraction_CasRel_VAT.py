...
with open('/data/corpus/relation_extraction/chip2020/53_schemas.json', encoding='utf-8') as f:
    for l in f:
        l = json.loads(l)
...
# 虚拟对抗添加
train_dataset = MyDataset('/data/corpus/relation_extraction/chip2020/train_data.json')
valid_dataset = MyDataset('/data/corpus/relation_extraction/chip2020/val_data.json')
