...
if choice == 'simbert':
    args_model_path = "E:/data/pretrain_ckpt/simbert/sushen@simbert_chinese_base"
    args_model = 'bert'
else:
    args_model_path = "E:/data/pretrain_ckpt/simbert/sushen@roformer_chinese_sim_char_base"
    args_model = 'roformer'
