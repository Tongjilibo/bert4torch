...
class BertClient(object):
    def __init__(self, batch_size=10, maxlen=128, use_tqdm=False):
        self.model = build_transformer_model(config_path=config_path, checkpoint_path=checkpoint_path, segment_vocab_size=0, with_pool=True, output_all_encoded_layers=True)
