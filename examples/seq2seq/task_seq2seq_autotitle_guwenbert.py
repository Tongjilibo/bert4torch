...
# bert配置
config_path = '/data/pretrain_ckpt/ethanyt/guwenbert-base/bert4torch_config.json'
checkpoint_path = '/data/pretrain_ckpt/ethanyt/guwenbert-base/pytorch_model.bin'
