...
config_path = 'E:/pretrain_ckpt/simbert/sushen@simbert_chinese_base/config.json'
checkpoint_path = 'E:/pretrain_ckpt/simbert/sushen@simbert_chinese_base/pytorch_model.bin'
dict_path = 'E:/pretrain_ckpt/simbert/sushen@simbert_chinese_base/vocab.txt'
