...
config_path = '/data/pretrain_ckpt/Tongjilibo/simbert-chinese-base/bert4torch_config.json'
checkpoint_path = '/data/pretrain_ckpt/Tongjilibo/simbert-chinese-base/pytorch_model.bin'
dict_path = '/data/pretrain_ckpt/Tongjilibo/simbert-chinese-base/vocab.txt'
