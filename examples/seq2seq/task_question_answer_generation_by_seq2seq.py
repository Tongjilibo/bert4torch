...
def process_data():
    if os.path.exists('/data/corpus/qa/CIPS-SOGOU/train_data_list_format.json'):
        return

    # 标注数据
    webqa_data = json.load(open('/data/corpus/qa/WebQA.json', encoding='utf-8'))
    sogou_data = json.load(open('/data/corpus/qa/SogouQA.json', encoding='utf-8'))
    ...
    json.dump(train_data, open('/data/corpus/qa/CIPS-SOGOU/train_data_list_format.json', 'w'), indent=4)
    json.dump(valid_data, open('/data/corpus/qa/CIPS-SOGOU/valid_data_list_format.json', 'w'), indent=4)
...
train_dataloader = DataLoader(MyDataset('/data/corpus/qa/CIPS-SOGOU/train_data_list_format.json'), 
                   batch_size=batch_size, shuffle=True, collate_fn=collate_fn) 
valid_dataset = MyDataset('/data/corpus/qa/CIPS-SOGOU/valid_data_list_format.json')
