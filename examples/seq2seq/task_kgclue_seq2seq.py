...
# 模型路径
config_path = '/data/pretrain_ckpt/junnyu/roformer_chinese_sim_char_ft_base/bert4torch_config.json'
checkpoint_path = '/data/pretrain_ckpt/junnyu/roformer_chinese_sim_char_ft_base/pytorch_model.bin'
dict_path = '/data/pretrain_ckpt/junnyu/roformer_chinese_sim_char_ft_base/vocab.txt'
