...
# bert配置
config_path = '/data/pretrain_ckpt/fnlp/bart-base-chinese/bert4torch_config.json'
checkpoint_path = '/data/pretrain_ckpt/fnlp/bart-base-chinese/pytorch_model.bin'
dict_path = '/data/pretrain_ckpt/fnlp/bart-base-chinese/vocab.txt'
...
model = build_transformer_model(config_path=config_path, checkpoint_path=checkpoint_path, keep_tokens=keep_tokens, add_trainer=True).to(device)
