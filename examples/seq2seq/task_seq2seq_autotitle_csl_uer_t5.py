...
# bert配置
config_path = '/data/pretrain_ckpt/uer/t5-base-chinese-cluecorpussmall/bert4torch_config.json'
checkpoint_path = '/data/pretrain_ckpt/uer/t5-base-chinese-cluecorpussmall/pytorch_model.bin'
dict_path = '/data/pretrain_ckpt/uer/t5-base-chinese-cluecorpussmall/vocab.txt'
