...
def process_data():
    if os.path.exists('E:/Github/bert4pytorch/examples/datasets/qa/train_data_list_format.json'):
        return
    ...
    json.dump(train_data, open('E:/Github/bert4pytorch/examples/datasets/qa/train_data_list_format.json', 'w'), indent=4)
    json.dump(valid_data, open('E:/Github/bert4pytorch/examples/datasets/qa/valid_data_list_format.json', 'w'), indent=4)
...
train_dataloader = DataLoader(MyDataset('E:/Github/bert4pytorch/examples/datasets/qa/train_data_list_format.json'), 
                   batch_size=batch_size, shuffle=True, collate_fn=collate_fn) 
valid_dataset = MyDataset('E:/Github/bert4pytorch/examples/datasets/qa/valid_data_list_format.json')
