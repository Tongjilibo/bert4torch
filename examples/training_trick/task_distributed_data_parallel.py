#! -*- coding:utf-8 -*-
# DDP示例
# 启动命令(旧)：python -m torch.distributed.launch --nproc_per_node=2 --nnodes=1 task_distributed_data_parallel.py
# 启动命令(新)：torchrun --nproc_per_node=2 --nnodes=1 task_distributed_data_parallel.py
