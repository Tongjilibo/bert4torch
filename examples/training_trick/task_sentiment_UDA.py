...
valid_dataset = MyDataset(['/data/corpus/sentence_classification/sentiment/sentiment.valid.data'])
test_dataset = MyDataset(['/data/corpus/sentence_classification/sentiment/sentiment.test.data'])
