...
checkpoint_path = '/data/pretrain_ckpt/google-bert/bert-base-chinese/pytorch_model.bin'  # 如果从零训练，就设为None
...
model = build_transformer_model(config_path=config_path, checkpoint_path=checkpoint_path, segment_vocab_size=0, with_mlm=True, add_trainer=True).to(device)
