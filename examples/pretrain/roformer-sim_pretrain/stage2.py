...
# ========== 蒸馏用：开始 ==========
# simbert配置
sim_config_path = 'E:/pretrain_ckpt/simbert/sushen@simbert_chinese_base/config.json'
sim_checkpoint_path = 'E:/pretrain_ckpt/simbert/sushen@simbert_chinese_base/pytorch_model.bin'
sim_dict_path = 'E:/pretrain_ckpt/simbert/sushen@simbert_chinese_base/vocab.txt'
