...
# 转换数据集
train_data = load_data('/data/corpus/ner/china-people-daily-ner-corpus/example.train')
valid_data = load_data('/data/corpus/ner/china-people-daily-ner-corpus/example.dev')
