...
config_path = 'G:/pretrain_ckpt/uie/uie_base_pytorch/config.json'
checkpoint_path = 'G:/pretrain_ckpt/uie/uie_base_pytorch/pytorch_model.bin'
dict_path = 'G:/pretrain_ckpt/uie/uie_base_pytorch/vocab.txt'
