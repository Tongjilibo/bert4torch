...
preprocess("/data/corpus/ner/china-people-daily-ner-corpus/example.train", './data/mid_data', "train")
preprocess("/data/corpus/ner/china-people-daily-ner-corpus/example.dev", './data/mid_data', "dev")
preprocess("/data/corpus/ner/china-people-daily-ner-corpus/example.test", './data/mid_data', "test")