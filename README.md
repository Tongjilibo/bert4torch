...
| roformer|roformer| 追一科技| [tf](https://github.com/ZhuiyiTechnology/roformer)，[torch](https://huggingface.co/junnyu/roformer_chinese_base) |[config](https://github.com/Tongjilibo/bert4torch/blob/master/examples/basic/roformer/sushen@roformer_v1_base) |
|         |roformer_v2 | 追一科技| [tf](https://github.com/ZhuiyiTechnology/roformer-v2)，[torch](https://huggingface.co/junnyu/roformer_v2_chinese_char_base)|[config](https://github.com/Tongjilibo/bert4torch/blob/master/examples/basic/roformer/sushen@roformer_v2_char_base) |
| simbert|simbert | 追一科技| [tf](https://github.com/ZhuiyiTechnology/simbert)，[torch_base](https://huggingface.co/peterchou/simbert-chinese-base/tree/main) | [转换脚本](https://github.com/Tongjilibo/bert4torch/blob/master/examples/basic/simbert/convert_simbert.py) [config](https://github.com/Tongjilibo/bert4torch/blob/master/examples/basic/simbert)|
...
| gpt2| cmp_lm(26亿)|清华 | [github](https://github.com/TsinghuaAI/CPM-1-Generate), [torch](https://huggingface.co/TsinghuaAI/CPM-Generate) | [config](https://github.com/Tongjilibo/bert4torch/blob/master/examples/basic/gpt2/cpm@cpm_lm_2.6b) |
...
| t5  | t5| UER | [torch](https://huggingface.co/uer/t5-base-chinese-cluecorpussmall)| [base](https://github.com/Tongjilibo/bert4torch/blob/master/examples/basic/t5/uer@t5-base-chinese-cluecorpussmall), [small](https://github.com/Tongjilibo/bert4torch/blob/master/examples/basic/t5/uer@t5-small-chinese-cluecorpussmall)|
...
|  moe  |deeoseek-moe|deepseek| [github](https://github.com/deepseek-ai/DeepSeek-MoE), [moe-16b-base](https://huggingface.co/deepseek-ai/deepseek-moe-16b-base), [moe-16b-chat](https://huggingface.co/deepseek-ai/deepseek-moe-16b-chat) | [config](https://github.com/Tongjilibo/bert4torch/blob/master/examples/basic/moe/deepseek-ai@deepseek-moe-16b-chat) |
| embedding| text2vec-base-chinese |shibing624| [base](https://huggingface.co/shibing624/text2vec-base-chinese) |[base](https://github.com/Tongjilibo/bert4torch/blob/master/examples/basic/embedding/shibing624@text2vec-base-chinese/bert4torch_config.json) |
|          | m3e |moka-ai| [base](https://huggingface.co/moka-ai/m3e-base) |[base](https://github.com/Tongjilibo/bert4torch/blob/master/examples/basic/embedding/moka-ai@m3e-base/bert4torch_config.json)|
|          | bge |BAAI| [large-en-v1.5](https://huggingface.co/BAAI/bge-large-en-v1.5), [large-zh-v1.5](https://huggingface.co/BAAI/bge-large-zh-v1.5) | [large-en-v1.5](https://github.com/Tongjilibo/bert4torch/blob/master/examples/basic/embedding/BAAI@bge-large-en-v1.5/bert4torch_config.json), [large-zh-v1.5](https://github.com/Tongjilibo/bert4torch/blob/master/examples/basic/embedding/BAAI@bge-large-zh-v1.5/bert4torch_config.json)|
