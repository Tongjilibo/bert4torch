...
## 3. 快速上手
- [说明文档](https://bert4torch.readthedocs.io/zh_CN/latest//Quick-Start.html)
...
## 5. 更新：
- **20221210**：增加macbert，text2vec-bert-chinese, wobert模型，增加LEAR示例，增加SPN4RE示例, transformer.configs支持点操作，可以使用torch4keras的Trainer(net)来初始化
